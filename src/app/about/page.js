    ...
    <div className="d-flex flex-column flex-md-row gap-5" id="aboutdiv">
      <div className="d-flex flex-column justify-content-center text-muted">
        ...
        <p className="  max-w-2xl">
          Kami adalah kelompok 3 prakarya kelas 9G SMP Negeri 1 Rejang Lebong
          (2024/2025) yang memiliki ambisi untuk membantu beberapa orang yang
          kesulitan mengutarakan perasaan atau bosan dengan kartu ucapan gambar
          yang itu itu saja. Web ini diharapkan dapat mempererat hubungan dan
          silahturahmi serta membantu orang-orang yang kesulitan mengutarakan
          perasaannya
        </p>
        ...
        <ul>
          <li>
            Najla Zeta Khairunisa (Reviewer design dan penyedia peralatan)
          </li>
